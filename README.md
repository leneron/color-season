...
# Dataset
The existing (old) dataset is accessible here: https://github.com/lorenzo-stacchio/Deep-Armocromia
`all.zip` contains my dataset (new):  https://drive.google.com/drive/folders/1hrs-jSGaW92PYLcqQvVCd2CZSvxG4d3t?usp=sharing
